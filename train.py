...
#parser.add_argument('data', metavar='DIR', type=str, default=r'C:\Users\30394986\python data',
...
def main():
    ...
    traindir = os.path.join(r'C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\python\__pycache__\Real_Train\ChallengeFree')
    testdir = os.path.join(r'C:\Users\30394986\OneDrive - Federation University Australia (1)\Desktop\python\__pycache__\Real_Test\ChallengeFree')
